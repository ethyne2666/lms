...
const CourseDetails = () => {
  ...
  const { allCourses, calculatingRating , calculateNoOfLectures,calculateCourseDuration, calculateChapterTime ,currency} = useContext(AppContext)
      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <div className='flex'>
              {[...Array(5)].map((_, i) => (<img className='w-3.5 h-3.5' key={i} src={assets.star_blank} alt='star' />))}
            </div>
          ...
          <p className='text-sm'>
            Course by <span className='text-blue-600 underline'>NullLogic</span>
          </p>
