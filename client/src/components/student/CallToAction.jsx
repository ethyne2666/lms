...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
        ...
        <p className='text-gray-500 sm:text-sm'> dolor sit amet, consectetur adipisicing elit. Dignissimos, fuga. Fuga quaerat aperiam, maxime numquam doloribus quidem corporis.</p>
