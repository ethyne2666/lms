...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3'>Discover our top-rated courses various categories. From coding and design to business and wellness, our courses are crafted to deliver resuts.</p>
